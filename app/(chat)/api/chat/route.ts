...
import { standardsChecklistComplianceTool } from '@/lib/ai/tools/standards-checklist-compliance';
      ...
      execute: (dataStream) => {
        ...
        const result = streamText({
          ...
          tools: {
            ...
            standardsChecklistCompliance: standardsChecklistComplianceTool({ chatId: id, session }),
          },
