...
export const TEST_PROMPTS: Record<string, CoreMessage> = {
  ...
  USER_NEXTJS: {
    role: 'user',
    content: [
      { type: 'text', text: 'Help me analyze architectural drawings and extract key specifications from PDF documents' },
    ],
  },
  ...
  USER_TEXT_ARTIFACT: {
    ...
    content: [
      {
        type: 'text',
        text: 'Extract building codes and compliance requirements from engineering documents',
      },
    ],
  },
